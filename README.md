...
- T_base→ee : 로봇 Forward Kinematics  
- T_ee→cam : Hand–Eye Calibration 결과  
- T_cam→target : Vision (PnP) 결과  
...
센서 노이즈로 인한 위치 데이터 변동(jitter)을 줄이기 위해 이동평균필터(MAF)를 적용하였다.

<img width="447" height="310" alt="image" src="https://github.com/user-attachments/assets/ee17c0d5-ec61-4f08-9ffc-ae3b709f5d1d" />
